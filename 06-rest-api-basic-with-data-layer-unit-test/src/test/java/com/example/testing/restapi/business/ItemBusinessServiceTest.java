 ...
 * 
 * When testing the business service, we DO NOT launch a spring context. We write a simple mockito test.
 * You should avoid launching Spring Contexts for unit tests when possible to improve the performance of your unit tests.
